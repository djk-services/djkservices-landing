          ...
          <Card className="p-6 animate-fadeIn">
            <CardContent className="p-0 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                David Smith is a veteran operator with 10+ years of experience leading product and engineering teams in fintech, media, and consumer tech. A former U.S. Navy servicemember, he brings disciplined execution and cross-functional leadership to every venture. David earned his Computer Engineering and Mathematics degree cum laude from the University of Florida and an MBA from Harvard Business School. He has scaled platforms to millions of users, built and led high-performing teams, and navigated regulated markets. David combines technical depth with strategic insight to build products that win.
              </p>
            </CardContent>
          </Card>
